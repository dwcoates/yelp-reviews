...
*** rating variance ~ rating average
   ...
   #+BEGIN_SRC R :session :exports results :results output graphics :file ./img/R_CCa0S6lS.png 
     g <- ggplot(data=business, aes(business$stars))
...
[[file:./img/R_CCa0S6lS.png]]
  ...
  src_R[:session]{median(business$stars.avg)} {{{results(=4=)}}}.
